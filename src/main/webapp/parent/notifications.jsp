...
<%
    if(session.getAttribute("userType") == null || !"parent".equals(session.getAttribute("userType"))) {
        response.sendRedirect("parentLogin.jsp");
        return;
    }

    // Your parent is linked using studentRollNumber
    ...
    try {
        ...
        Document unreadFilter = new Document("toUserType", "parent")
    ...
    <div class="container">
        ...
        <%
            try {
                ...
                FindIterable<Document> list = col.find(new Document("toUserType", "parent").append("toUserId", studentRollNumber))
        ...
        <%
                ...
                list = col.find(new Document("toUserType", "parent").append("toUserId", studentRollNumber))
                         .sort(new Document("createdAt", -1));

                for(Document n : list) {
                    any = true;
                    
                    // if isRead missing/null, treat as false (UNREAD)
            ...
            <div class="card">
                ...
                <div class="actions">
                    ...
                    <form action="<%=request.getContextPath()%>/MarkNotificationReadServlet" method="post" style="display:inline;">
                        ...
                        <input type="hidden" name="redirectTo" value="parent/notifications.jsp">
