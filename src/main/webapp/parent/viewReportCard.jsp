...
<%
    ...
    // Values set in ParentLoginServlet
    ...
    String studentEmail = (String) session.getAttribute("studentEmail"); // optional, only if you store it in session
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="report-container">
        ...
        %>
                    <div class="no-data">
                        ...
                        <p>The report card for this student has not been generated yet.</p>
                        <a href="parentDashboard.jsp" class="btn btn-back">← Back to Dashboard</a>
                    </div>
        <%
                } else {
