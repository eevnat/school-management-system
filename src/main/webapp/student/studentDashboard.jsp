...
<%
    ...
    try {
        ...
        Document student = studentCol.find(new Document("rollNumber", rollNumber)).first();
        if (student != null) {
            studentId = student.getString("studentId");
            session.setAttribute("studentId", studentId); // Store in session for later use
        }
    } catch(Exception e) {
        e.printStackTrace();
    }
    ...
    try {
        ...
        Document filter = new Document("toUserType", "student")
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .student-info strong { color: #3b82f6; }
        ...
        .card-btn:hover { background-color: #2563eb; }
...
<body>
    <div class="navbar">
        ...
        <div class="user-info">
            ...
            <a href="academicDashboard.jsp" class="dashboard-btn">📊 My Dashboard</a>
    ...
    <div class="container">
        <div class="welcome-card">
            ...
            <p>Access your academic information and performance.</p>

            <div class="student-info">
                <h3 style="color: #3b82f6; margin-bottom: 10px;">📚 My Profile</h3>
        ...
        <div class="dashboard-grid">
            ...
            <!-- 🔥 NEW: Exam Stress Reducer -->
            <div class="dashboard-card">
                <span class="hot-badge">HOT</span>
                <div class="card-icon">🧠</div>
                <h3>Exam Stress Reducer</h3>
                <p>Countdown timer & syllabus checklist</p>
                <a href="examStressReducer.jsp" class="card-btn">Prepare Smart</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="card-icon">📚</div>
                <h3>My Homework</h3>
                <p>View assigned homework & mark as completed</p>
                <a href="viewHomework.jsp" class="card-btn">View Homework</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="card-icon">📊</div>
                <h3>My Attendance</h3>
                <p>View your monthly attendance percentage</p>
                <a href="myAttendance.jsp" class="card-btn">View Attendance</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <% } %>
                <div class="card-icon">⭐</div>
                <h3>My Behavior Logs</h3>
                <p>View feedback from teachers</p>
                <a href="myBehaviorLogs.jsp" class="card-btn">View Logs</a>
            </div>
            
            <div class="dashboard-card">
                <div class="card-icon">📢</div>
                <h3>Notice Board</h3>
                <p>View latest notices and announcements</p>
            ...
            <div class="dashboard-card">
                <div class="card-icon">📈</div>
                <h3>View Marks</h3>
                <p>Check your subject-wise marks and performance</p>
            ...
            <div class="dashboard-card">
                ...
                <a href="applyLeave.jsp" class="card-btn">Apply Leave</a>
            </div>

            <div class="dashboard-card">
                <div class="card-icon">📌</div>
                <h3>My Leaves</h3>
                <p>Track your leave request approval status</p>
                <a href="myLeaves.jsp" class="card-btn">View Leaves</a>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <a href="notifications.jsp" class="card-btn">View Notifications</a>
            </div>
        </div>
    </div>
</body>
